                                ...
                                <div style="min-height: 120px;">
                                    <div class="collapse collapse-horizontal" id="collapseWidthExample1">
                                        <div class="card card-body" style="width: 360px;">
                                            <p><small>
                                                Чтобы совершить покупку, заходите в онлайн-каталог, в котором по
                                                категориям и фильтрам вы найдете нужные вам товары, выберите все
                                                параметры и оформите заказ через корзину сайта. После чего менеджер
                                                обязательно свяжется с вами, для уточнения и окончательного оформления
                                                доставки или самовывоза.</small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <div style="min-height: 120px;">
                                    <div class="collapse collapse-horizontal" id="collapseWidthExample3">
                                        <div class="card card-body" style="width: 300px;">
                                            <p>Гарантия указана в описании к каждому товару.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
